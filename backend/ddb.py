...
def sendtextupdate(recip, title, newprice):
    ...
    msg = f"Hello from LandYourGreen.space! The max bid on your plot \"{title}\" is now ${newprice}/acre"
...
class saleddbconn(ddbconn):
    ...
    def fmtentry__(self, **kw):
        ...
        data['crop'], data['station'] = self.aginf.getlocationinfo(data['location'])
